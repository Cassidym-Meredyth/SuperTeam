...
Данный проект предназначен для построения оптимальных маршрутов судов по арктическим морям, с учетом ледовой обстановки, погодных условий и ограничений. <br>Собранная инфраструктура позволяет запускать расчёты в Python-контейнере, а затем просматривать результаты (HTML-карты и отчёты) через веб-интерфейс Nginx.
